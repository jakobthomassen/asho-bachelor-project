...
export default function KursDetaljerScreen() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: Colors.background }]}>
      ...
      <Text style={[styles.text, { color: Colors.mutedText }]}>
        Fordyp praksisen gjennom kurs og retreats. Her kan backend senere legge
        inn kommende kurs, fysiske kurs, online kurs, datoer og påmelding.
      </Text>
    </View>
  );
}
